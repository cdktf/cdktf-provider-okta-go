...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourcesOrn", GoMethod: "ResetResourcesOrn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourcesOrn", GoGetter: "ResourcesOrn"},
			_jsii_.MemberProperty{JsiiProperty: "resourcesOrnInput", GoGetter: "ResourcesOrnInput"},
