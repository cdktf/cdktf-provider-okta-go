...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EmailTemplateSettings)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-okta.emailTemplateSettings.EmailTemplateSettingsConfig",
		reflect.TypeOf((*EmailTemplateSettingsConfig)(nil)).Elem(),
	)
}
