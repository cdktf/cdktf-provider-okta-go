...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enrollAuthenticatorTypes", GoGetter: "EnrollAuthenticatorTypes"},
			_jsii_.MemberProperty{JsiiProperty: "enrollAuthenticatorTypesInput", GoGetter: "EnrollAuthenticatorTypesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnrollAuthenticatorTypes", GoMethod: "ResetEnrollAuthenticatorTypes"},
