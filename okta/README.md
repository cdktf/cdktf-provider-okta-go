# CDKTF Go bindings for okta/okta provider version 4.14.1

This repo builds and publishes the [Terraform okta provider](https://registry.terraform.io/providers/okta/okta/4.14.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform okta provider](https://registry.terraform.io/providers/okta/okta/4.14.1)
