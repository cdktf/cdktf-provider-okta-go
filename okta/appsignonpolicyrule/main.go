...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "chains", GoGetter: "Chains"},
			_jsii_.MemberProperty{JsiiProperty: "chainsInput", GoGetter: "ChainsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetChains", GoMethod: "ResetChains"},
