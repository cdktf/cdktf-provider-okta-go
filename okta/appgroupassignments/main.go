...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-okta.appGroupAssignments.AppGroupAssignmentsTimeouts",
		reflect.TypeOf((*AppGroupAssignmentsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-okta.appGroupAssignments.AppGroupAssignmentsTimeoutsOutputReference",
		reflect.TypeOf((*AppGroupAssignmentsTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
