...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "channelJson", GoGetter: "ChannelJson"},
			_jsii_.MemberProperty{JsiiProperty: "channelJsonInput", GoGetter: "ChannelJsonInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetChannelJson", GoMethod: "ResetChannelJson"},
